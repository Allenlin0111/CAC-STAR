...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if getattr(configs, 'use_channel_mixer', 0):
            ...
            print("[PS] ChannelMixer-Head enabled.")
        ...
        # print(f"[PS] ms_patch={getattr(configs, 'use_ms_patch', 0)}, ms_router={getattr(configs, 'use_ms_router', 0)}")
        # print(f"[PS] patch_filter={getattr(configs, 'use_patch_filter', 0)}, patch_mixer={getattr(configs, 'use_patch_mixer', 0)}")
